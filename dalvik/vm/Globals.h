...
//#define COUNT_PRECISE_METHODS
    ...
    //for CAR
    unsigned int    pCallbackInvocation;
    pthread_t       pthreadMsgLoopThread;

    bool            shouldCARWorking;

    int             offJavaLangDelegate_value;
    int             offJavaLangDelegate_thisObj;
    int             offJavaLangDelegate_count;

    ClassObject    *classJavaLangAppletThread;
    int             offJavaLangThread_appletThread;
    int             offJavaLangAppletThread_id;
    void           *pAppletObj;

    ClassObject    *classJavaLangStringBuffer;
    Method         *methJavaLangStringBuffer;
};
