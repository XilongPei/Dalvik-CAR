...
LOCAL_CFLAGS += -Wall -Wextra -Wno-unused-parameter -Wno-non-virtual-dtor
...
LOCAL_SRC_FILES := \
	...
	native/dalvik_CAR_CARCallbackFunc.c \
	native/elastos_runtime.c \
	...
	CarSupport/elapiwrap.cpp \
	CarSupport/JavaCallbackInvocation/CJavaCallbackInvocation.cpp \
	CarSupport/JavaCallbackInvocation/_CJavaCallbackInvocation.cpp \
	CarSupport/JavaCallbackInvocation/CJavaCallbackInvocationClassObject.cpp \
	CarSupport/JavaCallbackInvocation/_JavaCallbackInvocationpub.cpp \
	CarSupport/JavaCallbackInvocation/_JavaCallbackInvocationabrg.cpp
...
LOCAL_C_INCLUDES += \
	...
	external/zlib \
	$(KERNEL_HEADERS) \
	dalvik/vm/CarSupport/include \
	dalvik/vm/CarSupport/JavaCallbackInvocation
...
ifeq ($(dvm_arch),x86)
  ifeq ($(dvm_os),linux)
    ...
    LOCAL_SRC_FILES += \
		...
		arch/$(dvm_arch_variant)/Call386ABI_CAR.S \
