...
static bool stringStartup()
{
    ...
    //for CAR Delegate
    ClassObject *classJavaLangDelegate =
        dvmFindSystemClassNoInit("Ljava/lang/Delegates;");
    gDvm.offJavaLangDelegate_value =
        dvmFindFieldOffset(classJavaLangDelegate, "CallbackMethods", "[I");
    gDvm.offJavaLangDelegate_thisObj =
        dvmFindFieldOffset(classJavaLangDelegate, "ThisObjs", "[I");
    gDvm.offJavaLangDelegate_count =
        dvmFindFieldOffset(classJavaLangDelegate, "count", "I");

    gDvm.classJavaLangStringBuffer =
            dvmFindSystemClassNoInit("Ljava/lang/StringBuffer;");
    gDvm.methJavaLangStringBuffer =
            dvmFindDirectMethodByDescriptor(gDvm.classJavaLangStringBuffer, "<init>", "(Ljava/lang/String;)V");
