...
//CAR support, no EABI ARM CPU
int dvmPlatformCARInvoke(void* pCARObject, int argInfo, int argc,
    const u4* argv, const char* shorty, void* func, void* out);
...
u4 dvmPlatformCARInvokeHints(const DexProto* proto);
...
typedef enum whyFindCARModuleInfo {
    kJustFindIt = 0,
    kAddRefCount = 1,
    kReleaseRefCount = 2,
} whyFindCARModuleInfo;
