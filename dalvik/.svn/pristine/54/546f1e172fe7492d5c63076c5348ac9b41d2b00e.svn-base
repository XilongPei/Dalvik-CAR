...
/*
 * static void CreateMsgLoopThread
 */
static void Dalvik_java_lang_VMThread_CreateMsgLoopThread(const u4* args, JValue* pResult)
{
    void *pAppletObj;

    dvmCreateMsgLoopThread(&pAppletObj);

    RETURN_INT((int)pAppletObj);
}
 ...
 * static void CreateMsgLoopThread
 */
static void Dalvik_java_lang_VMThread_ShutdownMsgLoopThread(const u4* args, JValue* pResult)
{
    void *pAppletObj = (void*)args[0];

    //the main MsgLoopThread can't be shutdown here
	if (pAppletObj == gDvm.pAppletObj)
	    return;
...
const DalvikNativeMethod dvm_java_lang_VMThread[] = {
    ...
    { "CreateMsgLoopThread", "()I",
        Dalvik_java_lang_VMThread_CreateMsgLoopThread },
    { "ShutdownMsgLoopThread", "(I)V",
        Dalvik_java_lang_VMThread_ShutdownMsgLoopThread },
    { NULL, NULL, NULL },
};
