...
/* InstField fields */
#ifdef PROFILE_FIELD_ACCESS
MTERP_OFFSET(offInstField_setter,   InstField, setter, 28)
MTERP_OFFSET(offInstField_getter,   InstField, getter, 32)
#else
MTERP_OFFSET(offInstField_setter,   InstField, setter, 20)
MTERP_OFFSET(offInstField_getter,   InstField, getter, 24)
#endif
...
/* StaticField fields
 * offStaticField_SGobject offset StaticField SetterGetterClassObject
 */
#ifdef PROFILE_FIELD_ACCESS
MTERP_OFFSET(offStaticField_SGobject,   StaticField, pSetterGetterClassObject, 32)
#else
MTERP_OFFSET(offStaticField_SGobject,   StaticField, pSetterGetterClassObject, 24)
#endif
